...
let example_specification_too_many_args =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = []; options = []; accept_varargs = false }
      in
...
let example_specification_not_enough_args =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = [ Positional; Positional ]; options = []; accept_varargs = false }
      in
      let args = [ Raw (Str "a") ] in
      Alcotest.(check spec_match_testable)
...
let example_specification_varargs_ok =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = [ Positional ]; options = []; accept_varargs = true }
      in
...
let example_specification_label_accept_no_label =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = [ Labeled "label" ]; options = []; accept_varargs = true }
      in
      let args = [ Raw (Str "a") ] in
      Alcotest.(check spec_match_testable)
        "Expected ok"
...
let example_specification_wrong_label =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = [ Labeled "label"; Positional ]
        ; options = []
        ; accept_varargs = true
        }
      in
...
let example_invalid_vararg_after_reorder =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = [ Labeled "label" ]; options = []; accept_varargs = false }
      in
      let args = [ Raw (Str "a"); Labeled ("label", Str "labeled") ] in
      Alcotest.(check spec_match_testable)
        "Expected mismatch"
...
let example_one_flag_option_no_arg =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = []; options = [ Flag "verbose" ]; accept_varargs = false }
      in
      let args = [] in
      Alcotest.(check spec_match_testable)
        "Expected ok"
...
let example_one_flag_option_only_varargs_passed =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = []; options = [ Flag "verbose" ]; accept_varargs = true }
      in
...
let example_two_options_only_one_passed =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        ...
        ; options = [ Flag "verbose"; Flag "force" ]
        ; accept_varargs = false
        }
      in
...
let example_invalid_option_values =
  ...
  , fun () ->
      let spec : Functions_spec.specification =
        { arguments = []
        ; options = [ Flag "verbose"; WithValue "output" ]
        ; accept_varargs = false
        }
      in
      let args =
